...
//            }
     ...
     */
    @RequestMapping(value = "/topic/message/{tname}/ajax", method = RequestMethod.GET)
    public void topicMessageAjax(@PathVariable("tname") String tname, HttpServletResponse response, HttpServletRequest request) throws ParseException {
        try{
            String stime = request.getParameter("stime");
            String etime = request.getParameter("etime");
            int partition = Integer.parseInt(request.getParameter("partition"));
            int page = Integer.parseInt(request.getParameter("page"));
            boolean needCount = Boolean.parseBoolean(request.getParameter("need_count"));
            HttpSession session = request.getSession();
            String clusterAlias = session.getAttribute(KConstants.SessionAlias.CLUSTER_ALIAS).toString();
            ...
            JSONObject result = topicService.listTopicMessage(clusterAlias, tmp);
